  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 text-center px-4 max-w-4xl mx-auto text-white">
        <h2 className="italic text-2xl md:text-3xl mb-4 text-bowl-gold font-serif">
        ...
        <a
          href="#Menu"
          className="inline-block px-10 py-4 b2 border-bowl-gold border text-bowl-gold tracking-[0.2em] hover:bg-bowl-gold active:bg-bowl-gold hover:text-bowl-charcoal  active:text-bowl-charcoal transition-all duration-300 uppercase"
        >
          View Menu
        </a>
      </div>
