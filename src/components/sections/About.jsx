...
const About = () => {
  return (
    <section id='About' className='bg-bowl-charcoal text-white'>
      <div className="flex flex-col md:flex-row h-auto">
        ...
        <div className="w-full md:w-1/2 p-12 md:p-24 flex flex-col justify-center bg-bowl-charcoal">
          <span className='text-bowl-gold font-bold tracking-widest uppercase text-xs mb-4'>Since 2015</span>
          ...
          <div className="mt-8 pt-8 border-t border-gray-700">
            <p className="font-serif italic text-xl text-bowl-gold">"Food is the ingredient that binds us together."</p>
