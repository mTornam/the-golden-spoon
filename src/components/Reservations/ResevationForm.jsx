...
const ResevationForm = () => {
  ...
  const fieldClassName =
    "w-full border-b border-gray-300 py-2 focus:outline-none focus:border-bowl-gold transition-colors bg-transparent text-gray-700 placeholder-gray-400";
  ...
  return isSubmitted ? (
    <div className="rounded-2xl border border-bowl-gold/30 bg-white/90 p-8 text-center shadow-lg">
      <p className="mb-3 text-sm uppercase tracking-[0.3em] text-bowl-gold">
        Reservation Received
      </p>
      <h3 className="mb-3 font-serif text-2xl text-bowl-charcoal">
      ...
      <button
        ...
        className="rounded-full border border-bowl-gold px-6 py-3 text-sm font-semibold uppercase tracking-widest text-bowl-gold transition hover:bg-bowl-gold hover:text-white"
      >
    ...
    <>
      <div className="text-center mb-8">
        <h2 className="font-serif text-3xl text-bowl-charcoal">
          Reserve Your Table
        </h2>
      ...
      <form id="reservation-form" className="space-y-6" onSubmit={handleSubmit}>
        <div
          id="form-feedback"
          className={`text-center text-sm pb-3 ${feedback.type === "success"
              ? "text-green-600"
              : feedback.type === "error"
                ? "text-red-600"
                : "hidden"
        ...
        <div className="pt-4">
          <button
            type="submit"
            className="w-full bg-bowl-gold text-white font-bold uppercase tracking-widest py-4 hover:bg-yellow-600 transition-colors shadow-md"
          >
            Book Table
          </button>
        </div>
